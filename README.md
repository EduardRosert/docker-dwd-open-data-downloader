...
Options:
  ...
  --max-time-step INTEGER         the maximung forecast time step to download,
                                  ...
                                  time-step - 12. If no max-time-step was
                                  defined, no data will be downloaded.
...
```
[downloader_cli.py:92 - downloadAndExtractBz2FileFromUrl() ] downloading file: 'https://opendata.dwd.de/weather/nwp/icon-eu/grib/21/t_2m/icon-eu_europe_regular-lat-lon_single-level_2020062521_000_T_2M.grib2.bz2'
[downloader_cli.py:105 - downloadAndExtractBz2FileFromUrl() ] saving file as: '/icon-eu_europe_regular-lat-lon_single-level_2020062521_000_T_2M.grib2'
[downloader_cli.py:108 - downloadAndExtractBz2FileFromUrl() ] Done.
[downloader_cli.py:92 - downloadAndExtractBz2FileFromUrl() ] downloading file: 'https://opendata.dwd.de/weather/nwp/icon-eu/grib/21/t_2m/icon-eu_europe_regular-lat-lon_single-level_2020062521_001_T_2M.grib2.bz2'
[downloader_cli.py:105 - downloadAndExtractBz2FileFromUrl() ] saving file as: '/icon-eu_europe_regular-lat-lon_single-level_2020062521_001_T_2M.grib2'
[downloader_cli.py:108 - downloadAndExtractBz2FileFromUrl() ] Done.
...
```